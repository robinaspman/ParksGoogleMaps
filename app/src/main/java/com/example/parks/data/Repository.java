                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            for (int j = 0; j < opHours.length(); j++) {
                                ...
                                JSONObject hours = opHours.getJSONObject(j).getJSONObject("standard");
                            ...
                            //Entrance fees
                            JSONArray entranceFeedArray = jsonObject.getJSONArray("entranceFees");
                            List<EntranceFees> entranceFeesList = new ArrayList<>();
                            for (int j = 0; j < entranceFeedArray.length(); j++) {
                                EntranceFees entranceFees = new EntranceFees();
                                entranceFees.setCost(entranceFeedArray.getJSONObject(j).getString("cost"));
                                entranceFees.setDescription(entranceFeedArray.getJSONObject(j).getString("description"));
                                entranceFees.setTitle(entranceFeedArray.getJSONObject(j).getString("title"));
