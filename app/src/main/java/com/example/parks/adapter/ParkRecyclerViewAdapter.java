...
public class ParkRecyclerViewAdapter extends RecyclerView.Adapter<ParkRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnParkClickListerner parkClickListerner;


    public ParkRecyclerViewAdapter(List<Park> parkList, OnParkClickListerner parkClickListerner) {
        this.parkList = parkList;
        this.parkClickListerner = parkClickListerner;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public OnParkClickListerner onParkClickListener;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            this.onParkClickListener = parkClickListerner;
